...
function SettingsScreen() {
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.sectionCcontainer}>
            ...
            <RadioButton.Group 
                ...
                <View style={styles.switchItem}>
                    <RadioButton value="pt" style={styles.radioItem}/>
                    <Text>Português</Text>
                </View>
                <View style={styles.switchItem}>
                    <RadioButton value="en" style={styles.radioItem}/>
                    <Text>Inglês</Text>
                </View>
                <View style={styles.switchItem}>
                    <RadioButton value="es" style={styles.radioItem}/>
                    <Text>Espanhol</Text>
                </View>
            </RadioButton.Group>
            </ScrollView>
